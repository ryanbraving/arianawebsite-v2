          ...
          <Typography component="h3" className={classnames("text", "textFR")}>
            ...
            <ul style={{ paddingRight: "1rem", listStyleType: "none" }}>
              ...
              <li style={{ paddingRight: "1rem" }}>
                ...
                خرید این بسته یعنی سرمایه گذاری روی خود برای شناخت و رهایی از
                محدودیتهای خود، درک نیازهای منحصر به فرد و خواسته های عمیق قلبی،
                رسیدن به شفافیت درونی و ویژنینگ و البته طراحی برنامه ای خاص برای
                روش زندگی با توجه به این نیازها، خواسته ها و ویژن زندگی. در طول
                این سفر شش ماهه، آریانا راهنما و مربی شما خواهد بود برای ساخت یک
                راه پله ایمن برای صعود، صعود از جایی که در حال حاضر ایستاده اید
                به جایی که با همه وجود می خواهید باشید. در این فرآیند شما
                ابزارهای علمی و عملی شیوه زندگی را می آموزید و بینش ارزشمندی کسب
                می کنید که در نتیجه آن می توانید در زندگیتان تغییرات پایدار
                ایجاد کنید، تغییراتی که سلامت جسمی، روحی، سطح انرژی، شادی، و
                بطور کلی شیوه زندگی شما را بهبود می بخشد.
              </li>
              <Link
                to="/coaching.request"
                style={{ textDecoration: "none" }}
